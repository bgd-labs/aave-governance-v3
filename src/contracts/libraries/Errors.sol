...
library Errors {
  ...
  string public constant INVALID_VOTING_PORTAL_VOTING_MACHINE = '54';
  string public constant INVALID_VOTING_PORTAL_GOVERNANCE = '55';
  string public constant INVALID_VOTING_MACHINE_CHAIN_ID = '56';
  string public constant SENDER_IS_NOT_CROSS_CHAIN_CONTROLLER = '57';
  string public constant G_INVALID_IPFS_HASH = '58';
  string public constant G_INVALID_PAYLOAD_ACCESS_LEVEL = '59';
  string public constant G_INVALID_PAYLOADS_CONTROLLER = '60';
  string public constant G_INVALID_PAYLOAD_CHAIN = '61';
  string public constant POWER_STRATEGY_HAS_NO_TOKENS = '62'; // power strategy should at least have
  string public constant INVALID_VOTING_CONFIG_ACCESS_LEVEL = '63';
  string public constant VOTING_DURATION_TOO_SMALL = '64';
  string public constant NO_BRIDGED_VOTING_ASSETS = '65';
  string public constant INVALID_VOTER = '66';
  string public constant INVALID_DATA_WAREHOUSE = '67';
  string public constant INVALID_L1_VOTING_PORTAL = '68';
  string public constant INVALID_VOTING_PORTAL_CHAIN_ID = '69';
  string public constant INVALID_VOTING_STRATEGY = '70';
  string public constant INVALID_VOTE_CONFIGURATION_BLOCKHASH = '71';
  string public constant INVALID_VOTE_CONFIGURATION_VOTING_DURATION = '72';
  string public constant INVALID_GAS_LIMIT = '73';
  string public constant INVALID_VOTING_CONFIGS = '74'; // a lvl2 voting configuration must be sent to initializer
  string public constant INVALID_EXECUTOR_DELAY = '75';
  string public constant REPEATED_STRATEGY_ASSET = '76';
  string public constant EMPTY_ASSET_STORAGE_SLOTS = '77';
  string public constant REPEATED_STRATEGY_ASSET_SLOT = '78';
  string public constant INVALID_EXECUTION_TARGET = '79';
  string public constant MISSING_VOTING_CONFIGURATIONS = '80'; // voting configurations for lvl1 and lvl2 must be included on initialization
  string public constant INVALID_PROPOSITION_POWER = '81';
  string public constant INVALID_YES_THRESHOLD = '82';
  string public constant INVALID_YES_NO_DIFFERENTIAL = '83';
  string public constant ETH_TRANSFER_FAILED = '84';
  string public constant INVALID_INITIAL_VOTING_CONFIGS = '85'; // initial voting configurations can not be of the same level
  string public constant INVALID_VOTING_PORTAL_ADDRESS_IN_VOTING_MACHINE = '86';
  string public constant INVALID_VOTING_PORTAL_OWNER = '87';
  string public constant CANCELLATION_FEE_REDEEM_FAILED = '88'; // cancellation fee was not able to be redeemed
  string public constant INVALID_CANCELLATION_FEE_COLLECTOR = '89'; // collector can not be address 0
  string public constant INVALID_CANCELLATION_FEE_SENT = '90'; // cancellation fee sent does not match the needed amount
  string public constant CANCELLATION_FEE_ALREADY_REDEEMED = '91'; // cancellation fee already redeemed
  string public constant INVALID_STATE_TO_REDEEM_CANCELLATION_FEE = '92'; // proposal state is not a valid state to redeem cancellation fee
  string public constant MISSING_REPRESENTATION_ROOTS = '93'; // to represent a voter the representation roots need to be registered
  string public constant CALLER_IS_NOT_VOTER_REPRESENTATIVE = '94'; // to represent a voter, caller must be the stored representative
  string public constant VM_INVALID_GOVERNANCE_ADDRESS = '95'; // governance address can not be 0
  string public constant ALL_DELEGATION_ACTIONS_FAILED = '96'; // all meta delegation actions failed on MetaDelegateHelper
}
